...
* :app combined /test + /androidTest codecov also available via [coverage-codecov.sh](https://raw.githubusercontent.com/jameshnsears/QuoteUnquote/development/bin/coverage-codecov.sh) - GitHub CI emulator can be flaky
* manifestTest* Build Variant + app.manifestTest Run/Debug Configuration provides additional coverage
