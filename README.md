...
* :app codecov also available via [coverage-codecov.sh](https://raw.githubusercontent.com/jameshnsears/QuoteUnquote/development/bin/coverage-codecov.sh) - GitHub CI emulator can be flaky
