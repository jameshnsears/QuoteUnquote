...
* :app codecov also available via [codecov.sh](https://raw.githubusercontent.com/jameshnsears/QuoteUnquote/development/bin/codecov.sh) - GitHub CI emulator can be flaky
* local sonarqube available via [sonarqube.sh](https://raw.githubusercontent.com/jameshnsears/QuoteUnquote/development/bin/sonarqube.sh)
