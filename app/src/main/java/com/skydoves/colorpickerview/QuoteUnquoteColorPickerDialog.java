...
public class QuoteUnquoteColorPickerDialog extends AlertDialog {
  ...
  public QuoteUnquoteColorPickerDialog(Context context) {
    super(context);
  }

  /** Builder class for create {@link QuoteUnquoteColorPickerDialog}. */
  public static class Builder extends MaterialAlertDialogBuilder {
    ...
    private int bottomSpace = QuoteUnquoteSizeUtils.dp2Px(getContext(), 10);
    ...
    /**
     * if true, attaches a {@link AlphaSlideBar} on the {@link QuoteUnquoteColorPickerDialog}.
     *
    ...
    /**
     * if true, attaches a {@link BrightnessSlideBar} on the {@link QuoteUnquoteColorPickerDialog}.
     *
     * @param value true or false.
     * @return {@link Builder}.
     */
    ...
    public Builder setBottomSpace(int bottomSpace) {
      this.bottomSpace = QuoteUnquoteSizeUtils.dp2Px(getContext(), bottomSpace);
      return this;
    }

    /**
     * sets positive button with {@link ColorPickerViewListener} on the {@link QuoteUnquoteColorPickerDialog}.
     *
    ...
    /**
     * shows a created {@link QuoteUnquoteColorPickerDialog}.
     *
